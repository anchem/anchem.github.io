...
上面是“该问什么”，[批判性思维实战手册](./critical-thinking-playbook.md)回答的是“怎么问、什么时候问、问到什么程度算完”：它把这份清单扩成五张可直接使用的表（信息质量、论证拆解、决策前中后提问、偏误预警信号、理性沟通），并给出分场景动作与 30 天训练计划。若需要的是把判断变成可复盘的习惯，从那份开始。
