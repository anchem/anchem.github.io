...
sidebar_position: 1
title: 批判性思维
description: 批判性思维是对思考本身的思考：一份逐条可问的清单，加上它的边界——它不负责想法的产生与构建，只负责评判思考与论证的质量。
tags:
  - '批判性思维'
keywords: [批判性思维, 思考质量, 论证评估, 隐藏假设, 结论边界, 思维清单]
---
...
上面的清单是“该问什么”，而[批判性思维实战手册](./overview.md)回答的是“怎么问、什么时候问、问到什么程度算完”：它把这份清单扩成五张可直接使用的表（信息质量、论证拆解、决策前中后提问、偏误预警信号、理性沟通），并给出分场景动作与 30 天训练计划。若需要的是把判断变成可复盘的习惯，从那份开始。
